...
public sealed class UpgradeCatalog
{
    ...
    /// </summary>
    public UpgradeDefinition Get(UpgradeType type) => _upgrades.TryGetValue(type, out var upgrade)
        ? upgrade
        : throw new KeyNotFoundException($"Unknown or unavailable upgrade '{type}'.");
}
