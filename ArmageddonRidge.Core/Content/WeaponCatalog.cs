...
public sealed class WeaponCatalog
{
    ...
    public WeaponCatalog()
    {
        var weapons = new[]
        {
            ...
            new WeaponDefinition(WeaponIds.SplitterMirv, "Splitter MIRV", WeaponCategory.Cluster, 500, 20, 20, 25, 1f, 1f, 0.9f, WeaponBehaviorType.Cluster, true, 0.05f, 1.45f, "Seven late-game fragments.", 7),
            ...
            new WeaponDefinition(WeaponIds.Gbu57Mop, "GBU-57 MOP", WeaponCategory.AreaDamage, 950, 105, 62, 130, 1.08f, 1.08f, 0.28f, WeaponBehaviorType.MultiStagePenetrator, true, 0.12f, 1.35f, "Arcade two-stage bunker buster: surface pop, then a deeper larger blast."),
