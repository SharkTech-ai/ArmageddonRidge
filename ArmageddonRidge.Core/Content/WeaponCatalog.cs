...
public sealed class WeaponCatalog
{
    ...
    public WeaponCatalog()
    {
        ...
        [
            ...
            new WeaponDefinition(WeaponIds.NapalmFlask, "Napalm Flask", WeaponCategory.Fire, 350, 15, 48, 40, 0.98f, 1.05f, 1.2f, WeaponBehaviorType.Napalm, true, 0f, 1.2f, "Wind-reactive long-range fire burst with a lingering hot zone.", RadiationTurns: 2, RadiationDamagePerTurn: 4),
            ...
            new WeaponDefinition(WeaponIds.ShahedDroneSwarm, "Shahed Drone Swarm", WeaponCategory.Cluster, 520, 18, 24, 22, 0.95f, 0.65f, 0.45f, WeaponBehaviorType.DroneSwarm, true, 0.03f, 1.4f, "Stylized triangular drone swarm: 3-5 powered, wandering impacts.", 5),
